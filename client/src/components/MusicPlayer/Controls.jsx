...
const Controls = ({ isPlaying, repeat, setRepeat, shuffle, setShuffle, currentSongs, handlePlayPause, handlePrevSong, handleNextSong,handleSaveMusic }) => (
  <div className="flex items-center justify-around md:w-36 lg:w-52 2xl:w-80">
    ...
    <GrFavorite size={25} onClick={handleSaveMusic} />
  </div>
);
