            ...
            <div key={post._id} className='shadow rounded-lg'>
              <article className="flex flex-col items-start justify-between p-1">
                ...
                <div className='likes-comments flex '>
                  <button className='flex'>{post.likes}<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-suit-heart like mr-4 ml-2" viewBox="0 0 16 16">
                  ...
                  <button className='flex'>{post.comments}<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-chat-dots comment ml-2" viewBox="0 0 16 16">
