...
function App() {
  ...
  return (
    <div className='relative flex'>
      <Navbar />
      {/* <Sidebar /> */}
      <header className='w-full h-screen flex justify-center items-center bg-white sm:px-8 px-4 py-4 border-b border-b-white m-5'>
        <div className="px-6 h-[calc(100vh-72px)] overflow-y-scroll hide-scrollbar flex xl:flex-row flex-col-reverse mt-5">
